...
export const Hero = () => {
  ...
  return (
    <div className="relative flex flex-col-reverse md:flex-row items-center justify-between w-full px-6 md:px-20 pt-20 md:pt-40 space-y-10 md:space-y-0">
      ...
      <div className="flex flex-col items-start justify-start space-y-4 text-center md:text-left">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight">
          Hi I'm <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">Ansh Pachauri.</span>
        </h1>
